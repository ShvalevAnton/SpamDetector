...
namespace MLModel1_ConsoleApp1
{
    ...
    {
        public const string RetrainFilePath =  @"Y:\01_Прораммирование\06_Предметы\09_Введение в анализ данных\SentimentAnalysis\wikipedia-detox-250-line-data.tsv.txt";
